      ...
      <div className="max-w-lg mx-auto px-5 py-8">
        ...
        <div className="mt-6 space-y-3 lg:hidden">
          ...
          <button
            ...
            className="w-full text-center font-body text-sm text-apt-mid hover:text-apt-dark transition-colors py-2"
          >
  ...
  const side = (
    <div className="flex flex-col justify-between h-full px-10 py-12">
      <div>
        ...
        <h2 className="font-display text-3xl font-bold text-apt-cream leading-tight mb-1">
          {matchedNeighbourhood.name}
        </h2>
        <p className="font-display italic text-apt-lime text-lg mb-8">
        ...
        <div className="space-y-3">
          ...
          <button
            type="button"
            onClick={() => { resetSession(); router.push('/') }}
            className="w-full text-center font-body text-sm text-apt-mid hover:text-apt-cream transition-colors py-2"
          >
            {en.result.startAgain}
          </button>
        </div>
      ...
      <div className="border-t border-apt-mid pt-8">
        ...
        <p className="font-body text-sm text-apt-cream leading-relaxed">
